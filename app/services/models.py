...
class Service(models.Model):
    ...
    cover = models.ImageField(verbose_name='Фотография обложки', blank=True, upload_to=upload_to)
...
class ServiceDescription(models.Model):
    ...
    cover = models.ImageField(verbose_name='Фотография подпункта', blank=True, upload_to=upload_to)
